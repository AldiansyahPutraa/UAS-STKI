...
$result=mysqli_query($koneksi,$query);
	...
	// tampilkan kotak pencarian dan jumlah hasil pencarian
	  ...
	  echo "<br /><br><table><tr><td></td><td><form action='SSTANIMOTO2.php' method='GET'><input type='text' onclick=value='' size='50' name='keyword' value='$keyword' style='width: 500px; height: 30px; font-size: 16px;'> <input type='submit' value='Search'></form></td></tr></table>";
...
echo "<td><font color=blue></font>" . " $row[STANIMOTO2] " . "<br></td>";  
